...
public class ProvideResponseParameters {
     ...
     */
    public ProvideResponseParameters(Network.Request request, Network.BytesValue body, List<Unknown> cookies, List<Unknown> headers, String reasonPhrase, Long statusCode) {
