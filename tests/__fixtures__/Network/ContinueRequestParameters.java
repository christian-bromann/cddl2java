...
public class ContinueRequestParameters {
     ...
     */
    public ContinueRequestParameters(Network.Request request, Network.BytesValue body, List<Network.CookieHeader> cookies, List<Object> headers, String method, String url) {
